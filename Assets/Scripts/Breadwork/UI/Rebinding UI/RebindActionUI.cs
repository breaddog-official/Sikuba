...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        /// </summary>
        public InputAction actionReference_Action
        {
            get => m_Action ? InputManager.Controls.FindAction(m_Action.action.id.ToString()) : null;
        }
        ...
        public void UpdateBindingDisplay()
        {
            ...
            var action = actionReference_Action;
            if (action != null)
            {
        ...
        public void ResetToDefault()
        {
            ...
            InputManager.SaveControlsOverrides();
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            for (var i = 0; i < s_RebindActionUIs.Count; ++i)
            {
                ...
                var referencedAction = component.actionReference_Action;
